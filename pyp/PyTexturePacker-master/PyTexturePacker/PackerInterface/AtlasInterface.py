    ...
    def dump_plist(self, texture_file_name="", input_base_path=None):
        ...
        for image_rect in self.image_rect_list:
            ...
            if image_rect.trimmed:
                print(image_rect.source_box, image_rect.source_size[0], image_rect.source_size[1])
                center_offset = (image_rect.source_box[0] - image_rect.source_size[0] / 2., image_rect.source_box[1] - image_rect.source_size[1] / 2.)
